...
namespace controlestoque.Controllers
{
    public class FornecedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Codigo,Nome,Id")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Codigo,Nome,Id")] Fornecedor fornecedor)
        {
            if (id != fornecedor.Codigo)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!FornecedorExists(fornecedor.Codigo))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
          return (_context.Fornecedor?.Any(e => e.Codigo == id)).GetValueOrDefault();
        }
    }
}
